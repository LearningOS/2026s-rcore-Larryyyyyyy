...
impl Inode {
    ...
    /// Link current inode to another inode
    /// example ln /data/old.txt /backup/new.txt
    /// self = /backup; name = new.txt; target = /data/old.txt
    ...
    /// Unlink current inode from another inode
    ...
    /// get link number of the given file
